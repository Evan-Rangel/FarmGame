...
if estado == "plantado" && global.time >= tiempo_necesario_para_crecer
{
    ...
    sprite_index = spr_lechuga2; // Cambia el sprite del cultivo
}
...
else if estado == "creciendo" && global.time >= tiempo_necesario_para_crecer * 2
{
    ...
    sprite_index = spr_lechuga3; // Cambia el sprite del cultivo
}
...
{
    case "plantado":
        sprite_index = spr_lechuga1;
        break;
    case "creciendo":
        sprite_index = spr_lechuga2;
        break;
    case "cosechable":
        sprite_index = spr_lechuga3;
        break;
}
